...
<div class="py-1">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Fill in the details below to add a new position to your organization.</p>
        </div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <div class="flex space-x-4 pl-10 py-2">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status" value="active" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300" {{ old('status', 'active') == 'active' ? 'checked' : '' }} required>
                                        <span class="ml-2 text-sm text-gray-700">Active</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="status" value="inactive" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300" {{ old('status') == 'inactive' ? 'checked' : '' }}>
            ...
            <div class="flex">
                ...
                <div class="ml-3 flex-1 md:flex md:justify-between">
                    <p class="text-sm text-blue-700">
                        <span class="font-medium">Note:</span> Fields marked with <span class="text-red-500">*</span> are required. The created_at and updated_at timestamps will be automatically set.
                    </p>
                </div>
            </div>
        </div>
