...
@section('title', 'PDS - Add Family Background')
@section('breadcrumbs')
    ...
    <li class="flex items-center">
        <i class="bi bi-chevron-right text-gray-300 dark:text-gray-600 mx-2 text-xs"></i>
        <span class="text-gray-800 dark:text-gray-200 font-medium">Add Family Background</span>
    </li>
@endsection
...
<div class="py-1">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Add Family Background</h1>
            <p class="mt-2 text-sm text-gray-600">Fill in the details below to add your family background information.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-lg font-semibold text-white">Family Background</h2>
                        <p class="text-sm text-indigo-100">Enter your family information</p>
                    </div>
            ...
            <!-- Form Body -->
            <form action="{{ route('family-background.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="spouse_first_name" value="{{ old('spouse_first_name') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_middle_name" value="{{ old('spouse_middle_name') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_last_name" value="{{ old('spouse_last_name') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_name_extension" value="{{ old('spouse_name_extension') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_employer_business" value="{{ old('spouse_employer_business') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_business_address" value="{{ old('spouse_business_address') }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="spouse_telephone_no" value="{{ old('spouse_telephone_no') }}" 
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="father_name_extension" value="{{ old('father_name_extension') }}" 
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="mother_maiden_last_name" value="{{ old('mother_maiden_last_name') }}" 
            ...
            <div class="flex">
                ...
                <div class="ml-3 flex-1 md:flex md:justify-between">
                    <p class="text-sm text-blue-700">
                        <span class="font-medium">Note:</span> Provide accurate family background information for your PDS record.
                    </p>
                </div>
            </div>
        </div>
